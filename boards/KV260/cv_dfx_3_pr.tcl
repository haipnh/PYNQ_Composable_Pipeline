...
proc create_hier_cell_composable { parentCell nameHier } {
  ...
  # Create instance: axis_data_fifo_b0, and set properties
  set axis_data_fifo_b0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_b0 ]
  set_property -dict [ list \
  ...
  # Create instance: axis_data_fifo_b1, and set properties
  set axis_data_fifo_b1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_b1 ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {16384} \
   CONFIG.FIFO_MEMORY_TYPE {ultra} \
   CONFIG.HAS_TKEEP {0} \
  ...
  # Create instance: axis_downconv_b0, and set properties
  set axis_downconv_b0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_downconv_b0 ]
  set_property -dict [ list \
  ...
  # Create instance: axis_downconv_b1, and set properties
  set axis_downconv_b1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_downconv_b1 ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {0} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  # Create instance: axis_upconv_b0, and set properties
  set axis_upconv_b0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_upconv_b0 ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {1} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  # Create instance: axis_upconv_b1, and set properties
  set axis_upconv_b1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_upconv_b1 ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {1} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  connect_bd_intf_net -intf_net duplicate_accel_stream_out  [get_bd_intf_pins axis_upconv_b0/S_AXIS] [get_bd_intf_pins duplicate_accel/M00_AXIS]
  connect_bd_intf_net -intf_net duplicate_accel_stream_out1 [get_bd_intf_pins axis_upconv_b1/S_AXIS] [get_bd_intf_pins duplicate_accel/M01_AXIS]
  connect_bd_intf_net -intf_net axis_downconv_b0_M_AXIS [get_bd_intf_pins axis_downconv_b0/M_AXIS] [get_bd_intf_pins axis_switch/S08_AXIS]
  connect_bd_intf_net -intf_net axis_downconv_b1_M_AXIS [get_bd_intf_pins axis_downconv_b1/M_AXIS] [get_bd_intf_pins axis_switch/S09_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_b0_M_AXIS [get_bd_intf_pins axis_data_fifo_b0/M_AXIS] [get_bd_intf_pins axis_downconv_b0/S_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_b1_M_AXIS [get_bd_intf_pins axis_data_fifo_b1/M_AXIS] [get_bd_intf_pins axis_downconv_b1/S_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_1_M_AXIS [get_bd_intf_pins axis_data_fifo_b0/S_AXIS] [get_bd_intf_pins axis_upconv_b0/M_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_2_M_AXIS [get_bd_intf_pins axis_data_fifo_b1/S_AXIS] [get_bd_intf_pins axis_upconv_b1/M_AXIS]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins clk_300MHz] [get_bd_pins axi_register_slice/aclk] [get_bd_pins axis_data_fifo_b0/s_axis_aclk] [get_bd_pins axis_data_fifo_b1/s_axis_aclk] [get_bd_pins axis_downconv_b0/aclk] [get_bd_pins axis_downconv_b1/aclk] [get_bd_pins axis_switch/aclk] [get_bd_pins axis_switch/s_axi_ctrl_aclk] [get_bd_pins axis_upconv_b0/aclk] [get_bd_pins axis_upconv_b1/aclk] [get_bd_pins colorthresholding_accel/ap_clk] [get_bd_pins dfx_decouplers/clk_300MHz] [get_bd_pins filter2d_accel/ap_clk] [get_bd_pins gray2rgb_accel/ap_clk] [get_bd_pins lut_accel/ap_clk] [get_bd_pins duplicate_accel/aclk] [get_bd_pins pipeline_control/s_axi_aclk] [get_bd_pins pr_0/clk_300MHz] [get_bd_pins pr_1/clk_300MHz] [get_bd_pins pr_fork/clk_300MHz] [get_bd_pins pr_2/clk_300MHz] [get_bd_pins ps_user_soft_reset/slowest_sync_clk] [get_bd_pins rgb2gray_accel/ap_clk] [get_bd_pins rgb2hsv_accel/ap_clk] [get_bd_pins smartconnect/aclk]
  ...
  connect_bd_net -net net_zynq_us_ss_soft_reset [get_bd_pins ps_user_soft_reset/peripheral_aresetn] [get_bd_pins axis_data_fifo_b0/s_axis_aresetn] [get_bd_pins axis_data_fifo_b1/s_axis_aresetn] [get_bd_pins axis_downconv_b0/aresetn] [get_bd_pins axis_downconv_b1/aresetn] [get_bd_pins axis_upconv_b0/aresetn] [get_bd_pins axis_upconv_b1/aresetn] [get_bd_pins colorthresholding_accel/ap_rst_n] [get_bd_pins dfx_decouplers/soft_rst_n] [get_bd_pins filter2d_accel/ap_rst_n] [get_bd_pins gray2rgb_accel/ap_rst_n] [get_bd_pins lut_accel/ap_rst_n] [get_bd_pins duplicate_accel/aresetn] [get_bd_pins pr_0/clk_300MHz_aresetn] [get_bd_pins pr_1/clk_300MHz_aresetn] [get_bd_pins pr_fork/clk_300MHz_aresetn] [get_bd_pins pr_2/clk_300MHz_aresetn] [get_bd_pins rgb2gray_accel/ap_rst_n] [get_bd_pins rgb2hsv_accel/ap_rst_n]
